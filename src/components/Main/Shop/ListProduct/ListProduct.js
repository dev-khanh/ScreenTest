...
class ListProduct extends Component {
    ...
    gotoDetail() {
        const { navigation } = this.props;
        navigation.push({ name: 'PRODUCT_DETAIL' });
    }
    render() {
        const { container, header, wrapper, backStyle, titleStyle, productContainer, productImage, productInfo, lastRowInfo, txtName, txtPrice, txtMaterial, txtColor, txtShowDetail } = styles;
        return (
